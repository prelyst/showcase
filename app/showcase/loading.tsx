...
function SidebarCard() {
  return (
    <div className="rounded-[16px] border border-border bg-card p-5">
      <div className="mb-4 h-4 w-28 rounded bg-skeleton" />
      <div className="space-y-3">
        <div className="h-3 w-full rounded bg-skeleton" />
        <div className="h-3 w-[88%] rounded bg-skeleton" />
        <div className="h-3 w-[72%] rounded bg-skeleton" />
      </div>
    </div>
  );
}
...
function FeedCard() {
  return (
    <div className="border-b border-divider py-6 first:pt-0 animate-pulse">
      ...
      <div className="space-y-3">
        ...
        <div className="h-4 w-[94%] rounded bg-skeleton" />
        <div className="h-4 w-[76%] rounded bg-skeleton" />
      </div>
