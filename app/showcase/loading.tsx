...
export default function ShowcaseLoading() {
  return (
    <ShowcaseShell title={<><span>Showcase </span><em className="font-light italic text-[#B8541F]">/ loading</em></>} active="/showcase/feed">
      <div className="grid max-w-[1100px] gap-10 xl:grid-cols-[1fr_320px] animate-pulse">
        <div>
          <div className="mb-6 flex border-b border-[#D9D3C4]">
            <div className="-mb-px h-10 w-24 border-b-2 border-[#B8541F]" />
